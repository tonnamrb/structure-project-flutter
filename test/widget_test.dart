...
import 'package:structure_project_flutter/app/controllers/welcome_controller.dart';
import 'package:structure_project_flutter/core/config/app_translation.dart';
import 'package:structure_project_flutter/presentation/page/welcome/welcome_page.dart';
...
void main() {
  ...
  testWidgets('renders welcome screen with register and login actions', (tester) async {
    ...
    final loginLabel = 'welcome.login'.tr;
    final registerLabel = 'welcome.register'.tr;
